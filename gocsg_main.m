...
%% Info
% This script uses code from the mTRF toolbox (see Copyright license below)

% BSD 3-Clause License
% 
% Copyright (c) 2014-2024, Lalor Lab, Trinity College Dublin
% All rights reserved.
...
% Raw audio and motion capture data can be found from the Trinity
% Speech-Gesture Database
...
% For questions or issues, contact Jacob Momsen: jacob.momsen@yale.edu
...
addpath(genpath('/Users/jpohaku/Documents/MATLAB/mocaptoolbox-1.6.6/'));
addpath  '/Users/jpohaku/Documents/MATLAB/mocap-master/matlab/';


homefolder='/Users/jpohaku/Documents/Yale/Research/YaleGespinOpenMind/';
...
%% Create skel files from bvh 

readme=[];
readme.Mfolder=[homefolder 'AVdata/mocap/bvh/'];
readme.outputfolder=[homefolder 'AVdata/mocap/skelfiles/'];
readme.setupfolder=[homefolder 'setup_files/'];

skelfiles=gocsg_bvh2skel(readme);

%% Create speeech envelope files from wav 

readme=[];
readme.Afolder=[homefolder 'AVdata/speech/wav/'];
readme.outputfolder=[homefolder 'AVdata/speech/envfiles/'];
readme.setupfolder=[homefolder 'setup_files/'];

envfiles=gocsg_wav2env(readme);
...
readme.Afolder=[homefolder 'AVdata/envfiles/'];
readme.Mfolder=[homefolder 'AVdata/skelfiles/'];
